...
* Random tasks
  ...
  * Search for TODOs, decide if you want to do them
  * Popup when transfer complete. No real feedback to user right now.
  ...
  * DONE How about showing what's in the envelope/pot currently (before the transfer) in the UI. Could just show it with a tooltip. Otherwise have to find space for it on UI.
